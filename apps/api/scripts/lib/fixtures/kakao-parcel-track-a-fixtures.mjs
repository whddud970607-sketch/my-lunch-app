/**
 * Mock Kakao address.json fixtures — derived from live validation gate (T01/T07/T09).
 * NETWORK=0; no secrets.
 */

function roadDoc({ bCode, mountainYn, mainNo, subNo, roadName, mainBuildingNo, subBuildingNo = "" }) {
  return {
...
export function buildMockFixtureMap() {
  const map = {};
